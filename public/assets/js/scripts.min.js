...
// Function to apply default class to SweetAlert confirm buttons
  function applyDefaultClass() {
    $('.swal2-confirm').removeClass().addClass('tertiary-btn t-btn btn me-2 px-5');
    $('.swal2-cancel, .swal2-deny').removeClass().addClass('btn-dark tertiary-btn btn me-2 px-5');
  }
  ...
  const observer = new MutationObserver(mutations => {
    mutations.forEach(mutation => {
      if (mutation.addedNodes.length) {
        // If new nodes are added, check if they are SweetAlerts and apply the default class
        applyDefaultClass();
      }
    });
  });

  // Configure the mutation observer to watch for changes in the body
