    ...
    <div style="padding: 0px 30px;">
        <div>
            @if ($order_details->basket->order_type == 'delivery')
                <div>
                    <p style="text-align: center; font-weight: 700; font-size: 30px; margin-top: 10px;">Your order is on its
                        way</p>
                </div>
            @else
                <div>
                    <p style="text-align: center; font-weight: 700; font-size: 30px; margin-top: 10px;">Your order has been
                        received</p>
                </div>
            @endif
            ...
            <table cellpadding="10" cellspacing="0" align="center" border="0" style="border:none;">
                ...
                <td align="center">
                    <big><strong>Invoice#: <span
                                style="color:#f20c0c;">{{ $order_details->invoice_id }}</span></strong></big>
                </td>
                </tr>
                <tr>
                    <td align="center">
                        <big><strong>Order Amount</strong></big>: <big><strong><span
                                    style="color:#f20c0c;">{{ getPrice($order_details->grandtotal) }}</span></strong></big>
                    </td>
                <tr>
            ...
            <div style="text-align:center; margin:15px">
                <a target="_new"
                    ...
                    style="margin:15px auto; padding:7px 10px; border-radius:5px;background-color:#f20c0c;color:#fff;opacity: 1;text-decoration:none;">ORDER
                    INQUIRY</a>
            </div>
                    ...
                    <tr>
                        <td style="padding-left: 15px; padding-right:15px; text-align:center;" valign="top">
                            <p>{{ strtoupper(titleText($billing_address->firstname) . ' ' . titleText($billing_address->lastname)) }}<br />{{ titleText($billing_address->address) }}<br />
                                ...
                                {{ titleText($billing_address->province) }}.
                            </p>
                            <p>
                            ...
                            @if ($pickupAddress)
                                <p style="margin: 0 0 10px 0;">
                                    ...
                                    <small><small><strong><a target="_new"
                                                    ...
                                                    style="color:#f20c0c;text-decortion:none;">VIEW
                ...
                @if ($order_details->grandtotal > 0)
                    <tr>
                        ...
                        <td align="right"><strong
                                style="color:#f20c0c;">{{ getPrice($order_details->grandtotal) }}</strong></td>
                    </tr>
                @endif
                    ...
                    @if ($order_details->basket->make_gift == 1)
                        <td>
                            ...
                            <p class="text-center" style="font-size: 18px;">
                                <i><strong>{{ $order_details->basket->card_msg }}</strong></i>
                            </p>
                        </td>
                    @endif
                </tr>
