...
@section('content')
    <div style="padding: 0px 30px;">
       <div>
           <div>
             <p style="text-align: center; font-weight: 700; font-size: 30px; margin-top: 10px;">Your order delivery/pickup location has been updated</p>
          </div>
                    ...
                    <td style="border-bottom: 1px solid #DDD;">
                        @if($items_listing->pre_order == 1)
                            <span  style="display:flex;align-items: center; font-weight:800">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#f591c1" viewBox="0 0 16 16">
