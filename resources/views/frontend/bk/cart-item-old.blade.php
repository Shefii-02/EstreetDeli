                                        ...
                                        <tr class="cart_item cart-item cart-item-{{$listing->id}} border-0 border-bottom">
                                          ...
                                          <td class="product-thumbnail text-center">
                                             ...
                                             <div class="product-remove">
                                                    <a class="edit_itm my-2" role="button" style="font-size:80%;display:inline-block;"  data-href="{{route('product-edit',$listing->id)}}"><i class="bi bi-pencil"></i> Edit </a> | 
                                                    
                                                    <a class="remove item_remove"  style="font-size:80%;display:inline-block;" data-preorder="" data-pname="{{$listing->product_name}}" data-psku="{{$listing->product_sku}}" data-pid="{{$listing->product_variation_id}}" data-id="{{$listing->id}}"  data-price="{{$listing->price_amount}}"  role="button">
                                          ...
                                          <td class="product-name" data-title="Product">
                                             ...
                                             @if($listing->upsell_product)
                                                    <small class="fw-semibold small mt-2 mb-2 d-flex">Combo packs</small>
                                                <div class="col-lg-12 mt-1 d-flex flex-wrap">
                                                    @foreach($listing->upsell_details as $upsell)
                                                        <p class="small cus_btn p-2 me-1 text-overflow mb-2">
                                                            {{ $upsell->name }} x {{$listing->quantity}}
                                                        </p>
                                                    @endforeach
                                                </div>
                                             @endif
